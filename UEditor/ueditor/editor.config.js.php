...
$plugin_options = Typecho_Widget::widget('Widget_Options')->plugin('UEditor');
?>
/**
 *  ueditor完整配置项
 *  可以在这里配置整个编辑器的特性
...
(function () {
     ...
     */
    var URL = '/usr/plugins/UEditor/ueditor/';
	window.UEDITOR_HOME_URL = '/usr/plugins/UEditor/ueditor/';
    ...
    var MY_UPLOAD_PATH = '/usr/uploads/';
    ...
    window.UEDITOR_CONFIG = {
        ...
        //,imagePath:URL + "php/"
        ,imagePath:MY_UPLOAD_PATH                    //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //,scrawlPath:URL+"php/"
        ,scrawlPath:MY_UPLOAD_PATH                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:URL+"php/fileUp.php"               //附件上传提交地址
        //,filePath:URL + "php/"
        ,filePath:MY_UPLOAD_PATH                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        ,catchRemoteImageEnable:<?php echo $plugin_options->catcher ? 'true' : 'false'; ?> //是否开启远程图片抓取,默认开启
        ,catcherUrl:URL +"php/getRemoteImage.php"   //处理远程图片抓取的地址
        ,catcherPath:MY_UPLOAD_PATH                  //图片修正地址，同imagePath
        ...
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                ...
                'insertimage', 'wordimage', 'emotion', 'scrawl', 'insertvideo','music','attachment', 'map', 'gmap', 'insertframe','highlightcode','background', '|',
        ...
        ,initialFrameWidth:708  //初始化编辑器宽度,默认1000
